...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><span class="font-weight-semibold">Edit</span> - Pasien</h4>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('pasiens/'.$pasien->id)}}" method="post">
                    @method('PATCH')
					@csrf
					<fieldset class="mb-3">
							...
							<div class="col-lg-10">
								<select name="gender_id" id="gender_id" class="form-control form-control-select2" data-container-css-class="border-teal-300" data-dropdown-css-class="border-teal-300" required>
                                    ...
                                    @foreach ($genders as $gender)
                                        <option value="{{$gender->id}}" {{$pasien->gender_id == $gender->id ? 'selected' : ''}}>{{$gender->nama}}</option>
                                    @endforeach
                                </select>
							</div>
                        </div>
					...
					<div class="text-right">
						<a href="{{ url('/pasiens')}}" class="btn btn-light">Kembali <i class="icon-undo"></i></a>
