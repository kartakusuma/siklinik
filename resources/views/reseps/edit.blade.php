...
@section('content')
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><span class="font-weight-semibold">Edit</span> - Resep Obat</h4>
	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="card-body">
				<form id="submit-form" class="form-validate-jquery" action="{{url('reseps/'.$resep->id)}}" method="post">
                    @method('PATCH')
					@csrf
					<fieldset class="mb-3">
								...
								<select name="ruang_id" id="ruang_id" class="form-control form-control-select2" data-container-css-class="border-teal-300" data-dropdown-css-class="border-teal-300">
                                    ...
                                    @if ($resep->ruang_id)
                                        @foreach ($ruangs as $ruang)
                                            <option value="{{$ruang->id}}" {{$resep->ruang_id == $ruang->id ? 'selected' : ''}}>{{$ruang->nomor}}</option>
                                        @endforeach
                                    @endif
                                </select>
							</div>
